    ...
    <form class="central" action="controler.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="textbox" class="form-control" id="produtoNome" name="produtoNome" readonly placeholder="nome" <?php echo"value='$name' "; ?>>
                <label for="produtoId">Nome:</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-floating formSpacing">
                <input type="number" class="form-control" id="produtoPreco" name="produtoPreco" readonly placeholder="Preço" <?php echo"value='$price' "; ?>>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-floating formSpacing">
                    <textarea rows="5" cols="20" class="form-control" style="height:fit-content" readonly id="produtoDescricao"  name="produtoDescricao" placeholder="Descrição" ><?php echo"$desc "; ?></textarea>
            ...
            <div class="col-md-6">
                <?php 
                    ...
                    echo'        <select class="form-control" id="produtoCategoria" name="produtoCategoria" readonly placeholder="Categoria">';
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-floating formSpacing">
                <input type="number" class="form-control" id="produtoQuantidade" name="produtoQuantidade" value="1">
                <label for="produtoPreco">quantidade:</label>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <button class="btn btn-primary py-2" type="submit" id="btnFazerPedido" name="btnFazerPedido">Concluir</button>
        <a class="btn btn-primary py-2" href="index.php">Cancelar</a>
        </div>
